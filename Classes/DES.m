...
{
    NSData *result = [self desCrypt:kCCEncrypt algorithm:kCCAlgorithmDES mode:kCCOptionPKCS7Padding|kCCOptionECBMode data:data key:key iv:NULL];
    return result;
}
...
{
    NSData *result = [self desCrypt:kCCDecrypt algorithm:kCCAlgorithmDES mode:kCCOptionPKCS7Padding|kCCOptionECBMode data:data key:key iv:NULL];
    return result;
}
